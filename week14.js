...
const myInformation = ['Elena', 21, 12, 'Sagitarius'];
...
const squaredNumbers = numbers.map(function (elem) {
    return elem * elem;
})
...
const filterEvenNumbers = numbers.filter(function(x) {
    const checking = x % 2;
    return checking === 0;
})
...
const sortAndPrint = [...randomNumbers].sort(function(a,b) {
    return a - b;
})
